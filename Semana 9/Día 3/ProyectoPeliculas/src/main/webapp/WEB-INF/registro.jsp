...
<html>
	...
	<body>
		<div class="container mt-3">
			...
			<div class="row">
				<form:form class="col-6" action="/agregar/director" method="POST" modelAttribute="nuevoDirector">
					<div>
					...
					<div>
						<form:label class="form-label" path="apellidos"> Apellidos: </form:label>
						<form:input class="form-control" path="apellidos" />
						<form:errors class="alert alert-danger d-block" path="apellidos" /> 
					</div>
					<div>
